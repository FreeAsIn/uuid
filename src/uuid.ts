 ...
 */
function characterReplacement(digitAsString: string): string {
    const digit = +digitAsString,
        randomValue = generateSecureRandomValue();
...
function generateSecureRandomValue(): number {
